/datum/hud/proc/larva_hud()
	...
	mymob.client.screen += list( mymob.zone_sel, mymob.healths, locate_queen, nightvisionicon, mymob.pullin, mymob.blind, mymob.flash) //, mymob.rest, mymob.sleep, mymob.mach )
