...
#define ui_alien_nightvision "EAST-1:28,CENTER+1:17"
#define ui_alien_health "EAST-1:28,CENTER:15"	//aliens have the health display where humans have the pressure damage indicator.
