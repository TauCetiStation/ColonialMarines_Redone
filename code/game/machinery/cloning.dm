...
/obj/item/weapon/paper/Director_note
	name = "Секретарше"
	info = {"<i>Передайте СЕ Бартусе Нареке что бы починил наконец охлаждение реактора. У нас нет финанансированиЯ на новые.
...
/obj/item/weapon/paper/Chief_enginer_note1
	...
	Воздуха хватит еще на три часа. Помощи ждать нам не от куда. Переговорил с парнями, будем взрывать реактор.</i>"}

/obj/item/weapon/paper/Chief_enginer_note2
	name = "Заметка СЕ №2"
	info = {"<i>СудЯ по всему внешний шлюз чем-то плавитсЯ. Через консоль камер смотреть не стоило - толпа монстров... Я открою эти чертовы двери и побегу в реакторную, песть эти твари бегут за мной, у менЯ длЯ них есть сурприз.</i>"}
