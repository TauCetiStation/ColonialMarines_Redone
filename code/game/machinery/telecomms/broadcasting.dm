			...
			if(istype(radio, /obj/item/device/radio/headset))
				...
				if(display_freq == MSUL_FREQ && !istype(hradio.keyslot2, command))
					...
					if(istype(hradio.keyslot2, squada))
						rendered = "[part_a][source] <b>\[ALead\]</b>[part_b]<b>\"[text]\"</b>[part_c]"
					if(istype(hradio.keyslot2, squadb))
						rendered = "[part_a][source] <b>\[BLead\]</b>[part_b]<b>\"[text]\"</b>[part_c]"
					if(istype(hradio.keyslot2, squadd))
						rendered = "[part_a][source] <b>\[DLead\]</b>[part_b]<b>\"[text]\"</b>[part_c]"
					if(istype(hradio.keyslot2, squadc))
						rendered = "[part_a][source] <b>\[CLead\]</b>[part_b]<b>\"[text]\"</b>[part_c]"
					if(istype(hradio.keyslot2, command))
						rendered = "<font size='3'>[part_a][source] <b>\[Command\]</b>[part_b]<b>\"[text]\"</b>[part_c]</font>"
