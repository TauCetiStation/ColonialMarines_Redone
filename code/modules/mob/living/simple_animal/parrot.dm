...
/mob/living/simple_animal/parrot/PolySir
	name = "Sir Lancevrot"
	desc = "Sir Lancevrot the Parrot. An expert on quantum cracker theory."
	speak = list("Капитан, бриг все еще просит помощи!", "Я выбрал не тот день что бы бросить пить...", "Кажется это конец...","Нужно подать сигнал СОС!", "That's it man! Game over man! Game over!","Не волнуйтесь, у нас много еды и оружия","Камерон Диан, держись до последнего!","Семнадцать дней?! Да мы и 17 часов не протянем!")
