...
/datum/preferences/proc/update_preview_icon()		//seriously. This is horrendous.
	...
	if(job_civilian_low & ASSISTANT)//This gives the preview icon clothes depending on which job(if any) is set to 'high'
		...
		switch(job_engsec_high)
			...
			if(MARINE)
				clothes_s = new /icon('icons/marines/marine_armor.dmi', "jumpsuit1_s")
				clothes_s.Blend(new /icon('icons/mob/feet.dmi', "jackboots"), ICON_UNDERLAY)
				clothes_s.Blend(new /icon('icons/mob/belt.dmi', "security"), ICON_OVERLAY)
				clothes_s.Blend(new /icon('icons/marines/marine_armor.dmi', "helmet"), ICON_OVERLAY)
				clothes_s.Blend(new /icon('icons/marines/marine_armor.dmi', "6"), ICON_OVERLAY)
				switch(backbag)
					if(2)
						clothes_s.Blend(new /icon('icons/mob/back.dmi', "backpack"), ICON_OVERLAY)
					if(3)
			...
			if(SULMED)
				...
				clothes_s.Blend(new /icon('icons/mob/inhands/items_lefthand.dmi', "firstaid"), ICON_UNDERLAY)
