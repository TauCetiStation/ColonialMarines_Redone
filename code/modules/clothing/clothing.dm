...
/obj/item/clothing/under
	...
	var/has_sensor = 2//For the crew computer 2 = unable to change mode
	var/random_sensor = 0
	var/sensor_mode = 2	/* 1 = Report living/dead, 2 = Report detailed damages, 3 = Report location */
	var/can_adjust = 1
	var/adjusted = 0
	var/suit_color = null
