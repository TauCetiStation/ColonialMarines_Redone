...
/obj/machinery/computer/shuttle/ex_act(severity, target)
	return

/obj/machinery/computer/shuttle/bullet_act(obj/item/projectile/Proj)
	return

/obj/machinery/computer/shuttle/attackby(obj/I, mob/user, params)
	return
