...
/obj/item/weapon/paper/crumpled/bloody
	name = "ќкровавленная записка"
	icon_state = "scrap_bloodied"
	info = {"<i> ажется это конец... я сильно порезался о стекло, которое лежало на барикадах, уже потер€л много крови. ћедбей в двух шагах,
	но твари напрочь отрезали мне путь.  ажется они учуяли кровь, и теперь еще сильнее напирают на барикады. ћне нужно немного отдохнуть...
	ѕрилягу... вс ее г о на пару минут...__________</i>"}
