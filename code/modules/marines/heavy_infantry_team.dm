...
proc/trigger_armed_infantry_team(var/force = 0)
	...
	priority_announce("A heavy infantry team has been requested and is preparing to be dispatched to the NMV Sulaco.", "Nanotrasen Special Forces")
...
/mob/living/carbon/human/proc/equip_infantry_team(leader_selected = 0)
	...
	//Special radio setup
	equip_to_slot_or_del(new /obj/item/device/radio/headset/mcom(src), slot_ears)
